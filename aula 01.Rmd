...
# AULA 01: Introdução ao R, RStudio e RMarkdown
...
```{r echo=TRUE}
library(readxl)
populacao01 <- read_excel("C:/ARQUIVOS COMPUTADOR/DOUTORADO/ESTÁGIO À DOCÊNCIA/CLAUDIONOR - UFU/SCRIPTS R E RMARKDOWN/populacao01.xls")
...
```{r echo=TRUE}
library(readxl)
localsp <- read_excel("C:/ARQUIVOS COMPUTADOR/DOUTORADO/ESTÁGIO À DOCÊNCIA/CLAUDIONOR - UFU/SCRIPTS R E RMARKDOWN/localsp.xls")
